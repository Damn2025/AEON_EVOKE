              ...
              <div className="mt-10 animate-on-scroll fade-in-up delay-200">
                <div className="flex flex-row items-center justify-center gap-4">
                  ...
                  <a
                    ...
                    className="bg-transparent border-2 border-yellow-500/50 text-yellow-400 font-semibold px-8 py-3.5 rounded-lg hover:border-yellow-400 hover:text-yellow-300 hover:bg-yellow-500/10 transition-all duration-300 hover:scale-105 text-base"
                  >
                    Know More
                  </a>
                </div>
