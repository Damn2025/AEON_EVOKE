        ...
        <div className="container mx-auto px-6 py-4 md:py-6 flex justify-between items-center">
          ...
          >
            <span className="relative">
              AEON
              <span className="text-yellow-500 group-hover:text-yellow-400 transition-colors duration-300">.</span>
      ...
      >
        <div className="flex-grow">
          <a
            ...
            onClick={closeMenu}
          >
            AEON<span className="text-yellow-500">.</span>
          </a>
