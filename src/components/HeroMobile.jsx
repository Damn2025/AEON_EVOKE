  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-[#0A0A0A] via-[#101010] to-[#0A0A0A] overflow-hidden pt-24 md:hidden">
      ...
      <div className="absolute inset-0 overflow-hidden z-0">
        <div className="absolute top-0 left-1/3 w-48 h-48 bg-yellow-500/5 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 right-1/3 w-48 h-48 bg-yellow-500/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
      </div> */}
            ...
            <div className="mt-8 animate-on-scroll fade-in-up delay-200">
              <div className="flex items-center justify-center gap-4">
                ...
                <a
                  ...
                  className="bg-transparent border-2 border-yellow-500/50 text-yellow-400 font-semibold px-6 py-3 rounded-lg hover:border-yellow-400 hover:text-yellow-300 hover:bg-yellow-500/10 transition-all duration-300 hover:scale-105 text-base w-full text-center"
                >
                  Know More
                </a>
              </div>
